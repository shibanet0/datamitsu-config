...
This configuration includes **14 project types**.

## Project Types Reference

| Project Type           | Description                        | Marker Files                                              |
| ---------------------- | ---------------------------------- | --------------------------------------------------------- |
| **docker-project**     | Docker image (Dockerfile)          | `**/Dockerfile`<br>`**/Dockerfile.*`<br>`**/*.Dockerfile` |
| **github-actions**     | GitHub Actions workflows           | `.github/workflows/*.yml`<br>`.github/workflows/*.yaml`   |
...
| **rust-project**       | Rust crate                         | `**/Cargo.toml`                                           |
