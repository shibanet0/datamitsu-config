...
export type ConfigNames =
  ...
  | "s0/clsx"
  | "s0/command/command"
  | "s0/compat/flat/recommended"
  | "s0/config-file"
  | "s0/de-morgan/rules"
  | "s0/depend"
  | "s0/disabled-rules"
  | "s0/e18e/rules"
  | "s0/escompat/flat/recommended"
  | "s0/eslint-comments/rules"
  | "s0/eslint-plugin-array-func/1"
  | "s0/fsecond/0"
  | "s0/fsecond/1"
  | "s0/html"
  | "s0/i18next"
  ...
  | "s0/js/rules"
  | "s0/js/setup"
  | "s0/jsdoc/flat/recommended"
  | "s0/json-schema-validator/0"
  | "s0/json-schema-validator/1"
  | "s0/json-schema-validator/2"
  | "s0/json-schema-validator/3"
  | "s0/json-schema-validator/4"
  | "s0/json/rules"
  | "s0/jsonc/0"
  | "s0/jsonc/1"
  | "s0/jsonc/2"
  ...
  | "s0/jsx-a11y/1"
  | "s0/jsx-a11y/rules"
  | "s0/n/node/flat/recommended-module"
  | "s0/n/node/flat/recommended-script"
  | "s0/n/rules"
  | "s0/next/rules"
  | "s0/no-unsanitized"
  | "s0/no-use-extend-native/recommended"
  | "s0/oxlint/from-oxlint-config"
  | "s0/oxlint/from-oxlint-config-override-0"
  | "s0/oxlint/from-oxlint-config-override-1"
  | "s0/oxlint/from-oxlint-config-override-2"
  | "s0/oxlint/oxlint-config-ignore-patterns"
  | "s0/oxlint/vue-svelte-astro-exceptions"
  | "s0/perfectionist/rules"
  | "s0/perfectionist/vanilla-extract/rules"
  | "s0/playwright/rules"
  | "s0/pnpm/package.json"
  | "s0/prettier/rules"
  | "s0/promise/rules"
  | "s0/react-hooks/rules"
  | "s0/react-prefer-function-component/rules"
  | "s0/react-refresh/rules"
  | "s0/react-you-might-not-need-an-effect"
  | "s0/react/1"
  | "s0/react/rules"
  | "s0/regexp"
  | "s0/security/rules"
  | "s0/sonarjs/1"
  | "s0/sonarjs/rules"
  | "s0/storybook/storybook:recommended:main-rules"
  | "s0/storybook/storybook:recommended:setup"
  | "s0/storybook/storybook:recommended:stories-rules"
  | "s0/stylistic"
  | "s0/turbo/recommended"
  | "s0/typescript"
  | "s0/typescript > typescript-eslint/base"
  | "s0/typescript > typescript-eslint/eslint-recommended"
  | "s0/typescript > typescript-eslint/recommended"
  | "s0/unicorn/1"
  | "s0/unicorn/rules"
  | "s0/unused-imports/rules"
  | "s0/vanilla-extract/rules"
  | "s0/vitest/rules";
