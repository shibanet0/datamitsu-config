/* eslint-disable perfectionist/sort-interfaces, perfectionist/sort-modules, perfectionist/sort-object-types, perfectionist/sort-union-types */ /**
 * Generated from dependabot_2.0_schema.json by `task dependabot:codegen` — do not edit. json2ts
 * decides the member order, so the style rules cannot be satisfied here.
 */
...
export type GitHubDependabotV2Config = {
  ...
  registries?: Registry;
  /**
   * Define groups that span multiple package ecosystems, allowing consolidated pull requests across
   * different ecosystems
   */
  "multi-ecosystem-groups"?: {
    [k: string]: MultiEcosystemGroup;
  };
};
/**
...
/**
 * The top-level registries key is optional. It allows you to specify authentication details that
 * Dependabot can use to access private package registries.
 */
export interface Registry {
  [k: string]: {
    ...
    type:
      ...
      | "terraform-registry";
    /**
     * The URL to use to access the dependencies in this registry. The protocol is optional. If not
     * specified, 'https://' is assumed. Dependabot adds or ignores trailing slashes as required.
     */
    url: string;
    /**
    ...
    token?: string;
    /**
     * For registries with type: python-index, if the boolean value is true, pip resolves
     * dependencies by using the specified URL rather than the base URL of the Python Package Index
     * (by default https://pypi.org/simple).
     */
...
/**
 * Define a group that spans multiple package ecosystems, allowing consolidated pull requests across
 * different ecosystems
 */
export interface MultiEcosystemGroup {
  ...
  /**
   * Associate all pull requests raised for this group with a milestone. You need to specify the
   * numeric identifier of the milestone and not its label.
   */
  milestone?: number;
  /**
